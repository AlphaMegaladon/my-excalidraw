...
4. **Beforeunload-Listener**: Verhindert Datenverlust beim schnellen Tab-Schließen, solange Änderungen in der Pipeline sind.
...
- **Positiv**:
  ...
  - Klare visuelle Unterscheidung zwischen „Gespeichert“, „Ungespeicherte Änderungen“ und „Speichert...“.
- **Negativ / Neutral**:
  - Geringfügig erweiterte State-Logik (`hasPendingChanges`, `isSavingRef`) zur Vermeidung redundanter paralleler Requests.
